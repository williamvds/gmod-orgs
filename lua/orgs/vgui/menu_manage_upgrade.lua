...
function PANEL:Init()
  ...
  self.TypeLabel =  l:orgs_AddLabel( 'Change to', 'orgs.Medium', orgs.C_WHITE )
  ...
  self.Type.OnSelect = function( p, id )
    ...
    self.Price:orgs_SetText( orgs.FormatCurrency( tp.Price ), nil,
      orgs.CanAfford( LocalPlayer(), tp.Price ) and orgs.C_WHITE or orgs.C_RED )
    ...
    self.MembersRequired:orgs_SetText( tp.MembersRequired, nil,
      org.Members < tp.MembersRequired and orgs.C_RED or orgs.C_WHITE )
    ...
    self.MaxMembers:orgs_SetText( tp.MaxMembers, nil,
      org.Members > tp.MaxMembers and orgs.C_RED or orgs.C_WHITE )
    ...
    self.MaxBalance:orgs_SetText( tp.MaxBalance, nil,
      org.Members > tp.MaxBalance and orgs.C_RED or orgs.C_WHITE )
    ...
    self.MaxBalance:orgs_SetText( orgs.FormatCurrency( tp.MaxBalance ), nil,
      org.Balance > tp.MaxBalance and orgs.C_RED or orgs.C_WHITE )
    ...
    self.CanAlly:orgs_SetText( tp.CanAlly and 'Yes' or 'No', nil,
      true and orgs.C_WHITE or orgs.C_RED ) -- TODO: Check alliances once implemeneted

    self.CanHide:orgs_SetText( tp.CanHide and 'Yes' or 'No', nil,
      true and orgs.C_WHITE or orgs.C_RED ) -- TODO: Check hiding once implemeneted
  ...
  for k, v in pairs( {{'Price','Cost to change'}, {'WalletWarning'},
    ...
    l = self:NewLine()
    if v[2] then
      self[v[1] ..'Label'] = l:orgs_AddLabel( v[2] ..':', 'orgs.MediumLight', orgs.C_WHITE )
      self[v[1] ..'Label']:orgs_Dock( LEFT, {l=10} )
      self[v[1] ..'Label']:SetContentAlignment( 9 )
    end
    self[v[1]] = l:orgs_AddLabel( '', 'orgs.Small', orgs.C_WHITE )
    self[v[1]]:orgs_Dock( LEFT, {l=5} )
    self[v[1]]:SetContentAlignment( 4 )
    self[v[1]]:SetWide( 500 )
    self[v[1]].l = l
  end
  self.WalletWarning:orgs_SetText( 'You don\'t have enough money in your wallet to pay!', nil, orgs.C_RED )
  self.WalletWarning.l:orgs_Dock( TOP, {u=0} )
  self.WalletWarning.l:Hide()

  self.BankWarning:orgs_SetText( 'You have too much money in the bank - some will be lost!', nil, orgs.C_RED )
  ...
  self.Confirm:orgs_BGR( orgs.C_DARKBLUE, orgs.C_BLUE )
  self.Confirm:orgs_Dock( BOTTOM, {l=150,r=150} )
  self.Confirm:SetTall( 30 )
  self.Confirm:orgs_SetText( 'Confirm', 'orgs.Medium', orgs.C_WHITE )
